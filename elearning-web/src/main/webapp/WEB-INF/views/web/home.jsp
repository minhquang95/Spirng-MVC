        ...
        <div class="active item">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span6"> <img src="template/web/img/slide/slide1.jpg"></div>
...
<div class="row">
    <div class="span6"><img src="template/web/img/responsive.png"></div>

    <div class="span6">
        <img class="hidden-phone" src="template/web/img/icon4.png" alt="">
